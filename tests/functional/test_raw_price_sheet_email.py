...
from app import db
from app.models import RawProduct, CostHistory, User, Company
...
def test_email_raw_price_sheet_single_recipient(client, app, logged_in_user, setup_raw_products):
    ...
    with patch('app.blueprints.raw_products.EmailMessage') as MockEmailMessage, \
         patch('app.blueprints.raw_products._generate_raw_price_sheet_pdf_bytes') as mock_gen_pdf:
