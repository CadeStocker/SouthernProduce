...
class TestAdminApprovalEmail:
    ...
    @patch('app.blueprints.auth.send_admin_approval_email')
    ...
    @patch('app.blueprints.auth.EmailMessage')
    def test_admin_approval_email_content(self, mock_email_class, app, setup_company_with_admin):
        ...
        from app.blueprints.auth import send_admin_approval_email
...
class TestPasswordResetEmail:
    ...
    @patch('app.blueprints.auth.send_reset_password_email')
...
class TestPriceSheetEmail:
    ...
    @patch('app.blueprints.pricing.EmailMessage')
    @patch('app.blueprints.pricing._generate_price_sheet_pdf_bytes')
